...
def face_capture(net, frame, conf_threshold = 0.7):
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > conf_threshold:
            ...
            cv2.rectangle(frameOpencvDnn, (x1, y1), (x2, y2), (255, 255, 0), 4)
...
# получаем видео из файла
# video = cv2.VideoCapture(r"Путь к видео")
...
while cv2.waitKey(1) < 0:
    ...
    resultImg, faceBoxes = face_capture(faceNet,frame)
    # если лиц нет
    if not faceBoxes:
